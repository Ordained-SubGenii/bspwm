#!/bin/bash
## Modified Date: 01/02/2021 ...
## Commented out nonexistent if $BAT_PATH/charge statement
## Commented out and replaced if [[ $bat_percent -lt $LOW_BAT && "$bs" = "Discharging" $launched -lt 3 ] due to ambigous expression $launched -lt 3
## Commented out and replaced  ls -1qA /sys/class/power_supply/ | grep -q BAT
### VARIABLES
